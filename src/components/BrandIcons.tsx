...
export const ConstellationIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line x1="12" y1="4" x2="6" y2="10" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="12" y1="4" x2="18" y2="10" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="6" y1="10" x2="8" y2="18" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="18" y1="10" x2="16" y2="18" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="6" y1="10" x2="18" y2="10" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="8" y1="18" x2="16" y2="18" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const ZodiacIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line x1="5.6" y1="5.6" x2="8.2" y2="8.2" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="15.8" y1="15.8" x2="18.4" y2="18.4" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="18.4" y1="5.6" x2="15.8" y2="8.2" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="8.2" y1="15.8" x2="5.6" y2="18.4" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const ScoreChartIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="13" width="4" height="8" rx="1" fill="white" />
    <rect x="10" y="8" width="4" height="13" rx="1" fill="white" />
    <rect x="16" y="3" width="4" height="18" rx="1" fill="white" />
  </svg>
);
...
export const LuckyCompassIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="9" stroke="white" strokeWidth="1.5" />
    <polygon points="12,5 14,11 12,10 10,11" fill="white" />
    <polygon points="12,19 10,13 12,14 14,13" fill="white" opacity="0.5" />
    <circle cx="12" cy="12" r="1.5" fill="white" />
    <line x1="12" y1="3" x2="12" y2="5" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="12" y1="19" x2="12" y2="21" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="3" y1="12" x2="5" y2="12" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
...
export const LockIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="6" y="11" width="12" height="9" rx="2" stroke="white" strokeWidth="1.5" />
    <path
...
const TaurusIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="15" r="6" stroke="white" strokeWidth="2" />
    <path
      d="M5 3C5 3 5 7 8 7"
      stroke="white"
      strokeWidth="2"
...
const GeminiIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <line x1="8" y1="4" x2="8" y2="20" stroke="white" strokeWidth="2" strokeLinecap="round" />
    <line x1="16" y1="4" x2="16" y2="20" stroke="white" strokeWidth="2" strokeLinecap="round" />
    <path d="M5 4H19" stroke="white" strokeWidth="2" strokeLinecap="round" />
...
const CancerIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      strokeLinecap="round"
    />
    <circle cx="7" cy="10" r="3" stroke="white" strokeWidth="2" />
    <path
      ...
      strokeLinecap="round"
    />
    <circle cx="17" cy="14" r="3" stroke="white" strokeWidth="2" />
  </svg>
);
...
const VirgoIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <line x1="16" y1="18" x2="20" y2="14" stroke="white" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
const LibraIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line x1="12" y1="20" x2="12" y2="10" stroke="white" strokeWidth="2" strokeLinecap="round" />
    <path
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <line x1="4" y1="10" x2="20" y2="10" stroke="white" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
const SagittariusIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <polyline points="13,5 19,5 19,11" stroke="white" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    <line x1="7" y1="13" x2="13" y2="19" stroke="white" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
const CapricornIcon: React.FC<IconProps> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16 14C16 14 16 17 15 17" stroke="white" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
